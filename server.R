...
shinyServer(
  function(input,output){
    ...
    MTDbarplot <- reactive({
      ...
      return(ggplot(data = tempDataFrame, aes(x = Dose_Level , y = Probabilities_of_Each_Dose_Chosen_as_MTD)) + labs(y = "Probability", x = "Dose Level", title = "Probability of Each Dose Chosen as MTD") + theme(plot.title = element_text(size = 20, face = "bold",hjust = 0.5),axis.text = element_text(size = 15),axis.title = element_text(size = 15), axis.line = element_line(arrow = arrow())) + geom_bar(stat = "identity",fill = "#004990",colour="#004990")+scale_x_continuous(breaks = c(0:(length(tempoutput))),expand=c(0,0))+scale_y_continuous(limit = c(0,((apply(t(tempDataFrame$Probabilities_of_Each_Dose_Chosen_as_MTD),1,max))*1.1)),expand=c(0,0)))
    ...
    MTDscatterplot <- reactive({
      ...
      return(ggplot(data = tempDataFrame, aes(x = Probability_of_Toxicity , y = Probability_as_MTD_by_Probability_of_Toxicity,group = 1)) + labs(y = "Probability", x = "Probability of Toxicity", title = "Probability as MTD") + theme(plot.title = element_text(size = 20, face = "bold",hjust = 0.5),axis.text = element_text(size = 15),axis.title = element_text(size = 15), axis.line = element_line(arrow = arrow()) ) + geom_point(fill = "#004990",colour="#004990") + geom_line(colour="#004990") + scale_x_continuous(limits = c(0,1),expand=c(0,0))+scale_y_continuous(limit = c(0,((apply(tempoutput[3,],1,max))*1.1)),expand=c(0,0)))
    ...
    ptNumbarplot <- reactive({
      ...
      return(ggplot(data = tempDataFrame, aes(x = Dose_Level , y = Expected_Number_of_Patients_Treated_at_Each_Dose_Level,group = 1)) + labs(y = "Number", x = "Dose Level", title = "Expected Number of Patients Treated") + theme(plot.title = element_text(size = 20, face = "bold",hjust = 0.5),axis.text = element_text(size = 15),axis.title = element_text(size = 15), axis.line = element_line(arrow = arrow()) ) + geom_bar(stat = "identity",fill = "#004990",colour="#004990") + scale_x_continuous(breaks = c(1:(length(tempoutput))),expand=c(0,0))+scale_y_continuous(limit = c(0,((apply(tempoutput[4,],1,max))*1.1)),expand=c(0,0)))
      #png(sprintf( paste(outputdirectory,"scatterplot ",row.names(tempoutput[(x+2),]),counter,".jpeg",sep = "")))
      #p <- ggplot(data = tempDataFrame, aes(x = Probability_of_toxicity , y = Probabilities_that_the_dose_is_chosen_as_MTD,group = 1)) + geom_point(fill = "#004990",colour="#004990") + geom_line(colour="#004990") + scale_x_continuous(limits = c(0,1))
      #print(p)
      #dev.off()
    ...
    toxincbarplot <- reactive({
      ...
      return(ggplot(data = tempDataFrame, aes(x = Dose_Level , y = Expected_Number_of_Dose_Limiting_Toxicity_at_Each_Dose_Level,group = 1)) + labs(y = "Number", x = "Dose Level", title = "Expected Number of Dose Limiting Toxicity") + theme(plot.title = element_text(size = 20, face = "bold",hjust = 0.5),axis.text = element_text(size = 15),axis.title = element_text(size = 15), axis.line = element_line(arrow = arrow()) ) + geom_bar(stat = "identity",fill = "#004990",colour="#004990") + scale_x_continuous(breaks = c(1:(length(tempoutput))),expand=c(0,0))+scale_y_continuous(limit = c(0,((apply(tempoutput[5,],1,max))*1.1)),expand=c(0,0)))
      #png(sprintf( paste(outputdirectory,"scatterplot ",row.names(tempoutput[(x+2),]),counter,".jpeg",sep = "")))
      #p <- ggplot(data = tempDataFrame, aes(x = Probability_of_toxicity , y = Probabilities_that_the_dose_is_chosen_as_MTD,group = 1)) + geom_point(fill = "#004990",colour="#004990") + geom_line(colour="#004990") + scale_x_continuous(limits = c(0,1))
      #print(p)
      #dev.off()
    ...
    toxinccatterplot <- reactive({
      ...
      return(ggplot(data = tempDataFrame, aes(x = Probability_of_toxicity , y = Expected_Number_of_Dose_Limiting_Toxicity_by_Probability_of_Toxicity,group = 1)) + labs(y = "Number", x = "Probability of Toxicity", title = "Expected Number of Dose Limiting Toxicity") + theme(plot.title = element_text(size = 20, face = "bold",hjust = 0.5),axis.text = element_text(size = 15),axis.title = element_text(size = 15), axis.line = element_line(arrow = arrow()) ) + geom_point(fill = "#004990",colour="#004990") + geom_line(colour="#004990") + scale_x_continuous(limits = c(0,1),expand=c(0,0))+scale_y_continuous(limit = c(0,((apply(tempoutput[5,],1,max))*1.1)),expand=c(0,0)))
      #png(sprintf( paste(outputdirectory,"scatterplot ",row.names(tempoutput[(x+2),]),counter,".jpeg",sep = "")))
      #p <- ggplot(data = tempDataFrame, aes(x = Probability_of_toxicity , y = Probabilities_that_the_dose_is_chosen_as_MTD,group = 1)) + geom_point(fill = "#004990",colour="#004990") + geom_line(colour="#004990") + scale_x_continuous(limits = c(0,1))
      #print(p)
      #dev.off()
